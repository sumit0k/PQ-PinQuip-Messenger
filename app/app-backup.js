...
var express = require('express'),
	...
	//ftpserver = require('blueimp-file-upload-node'),
	...
	options = {
		...
		uploadUrl: '/files/',
		maxPostSize: 110000000, // 11 GB
		minFileSize: 1,
		maxFileSize: 100000000, // 10 GB
		acceptFileTypes: /.+/i,
...
// ftpserver.createFtpServer(function () {
// 	console.log('FTP Server Created');
// });
// FTP server configurations
...
if (options.ssl) {
	require('https').createServer(options.ssl, serve).listen(8000);
} else {
